...
<div class="sidebar">
    ...
    <!-- Remove Department and Building, and add Create Room -->
    <div class="nav-item">
        <a href="<?php echo e(route('roomdash')); ?>" class="nav-link">CREATE ROOM</a> <!-- Link to Create Room -->
    </div>
...
<?php /**PATH C:\Users\Justine Cedric\OneDrive\Desktop\SIR RANIEL AJ IGNACIO\BSIT-3-1-SMS\resources\views/components/include/adminsidebar.blade.php ENDPATH**/ ?>